...
|--------|----------------|
| [`manifest-dev`](claude-plugins/manifest-dev) | The workflow itself, project setup, ticket authoring and execution, first-principles design guidance (`/design`), artifact review, and the review skills the criteria call on |
