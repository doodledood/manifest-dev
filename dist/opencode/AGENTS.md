...
- **Tools skills** — /adr, /babysit-pr, /handoff, /prompt-engineering, /review-pr, and /walk-pr install with the `-manifest-dev-tools` suffix. /babysit-pr is the author-side companion to /review-pr and supports CI one-shot advancement via `--ci`.
