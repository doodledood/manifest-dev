...
- **/design** — Builds or restyles a user-visible artifact — page, dashboard, document, deck, form, game — starting from the audience's work and context, combining art direction with information and interaction design, and verifying the delivered experience.
