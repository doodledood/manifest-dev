...
1. Create the ticket issues first, then the tracking issue referencing them by number, then attach each ticket to it as a sub-issue — edges and relations need real numbers.
