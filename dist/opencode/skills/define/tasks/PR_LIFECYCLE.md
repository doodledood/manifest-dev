...
- **No force-push, no push to a base branch** (main, master, develop) — the `check-pr` skill's hard prohibitions; PR_LIFECYCLE inherits them. Merging base into head — the Update-branch sync — is permitted.
