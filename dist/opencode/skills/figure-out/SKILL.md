...
- **Topic batching** — surfacing several findings, observations, or questions in one response with "thoughts?" at the end. Even when each item is short, cumulative load forces the user to hold everything before replying. One topic, wait, next topic — even when you have more on your mind.
