...
|------|-------|-------------|
| Skills | 19 | Core workflow skills plus manifest-dev-tools utilities (incl. `review-code`, `check-pr`, `poll-slack`, `review-prompt`) |
...
| Commands | 17 | Runtime command wrappers registered by the plugin for user-invocable skills; no command files are copied or generated |
