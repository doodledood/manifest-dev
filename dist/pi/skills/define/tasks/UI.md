...
- **Build with the design skill** — Invoke the `design` skill when creating or restyling the artifact; it front-loads the purpose/register decision, the token system, and the floor checklist the gate will later judge
