...
- **Unbuilt solution** — Does this rest on a design or technical solution nobody has actually produced yet? Assuming one exists is where the schedule-breaking surprises live.
- **Decisions deferred into execution** — Is there a hard call better settled now than mid-implementation, where picking wrong costs a dead end nobody has time to unwind?
