...
| `chat-surface` skill | always, in the mode `--surface` names — `terminal` by default | the rendering contract that selects a turn's form, plus that destination's form vocabulary |
