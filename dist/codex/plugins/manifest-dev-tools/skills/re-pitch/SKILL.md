...
- Invoke the `manifest-dev:chat-surface` skill with: `text` — it owns which form carries each point, and this skill states none of its own. If it is not available, shape the re-pitch by your own judgment.
