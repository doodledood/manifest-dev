...
**If the user later supplies a scope or requirement change**, invoke `define`
with the Manifest path, then resume the executor. If they clear the blocker
