...
- **Build with the design skill** — Invoke the `design` skill when creating or restyling the artifact; it establishes the audience's experience, task model and creative direction, and preserves the requirements the gate will judge
