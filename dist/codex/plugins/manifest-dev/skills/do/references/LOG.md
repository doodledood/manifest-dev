...
- **Sub-threshold findings** — what a gate reported below its own threshold and was handed over rather than repaired, and any pre-existing issue met along the way and left as unrelated to the change.
