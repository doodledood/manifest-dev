...
| Plugin | Skills |
|--------|--------|
| `manifest-dev` | `define`, `do`, `just-do`, `auto`, `just-auto`, `done`, `escalate`, `figure-out`, `figure-out-team`, `init-context`, `check-pr`, `poll-slack`, `review-code`, `ticket-up`, `next-ticket`, `run-ticket`, `sweep-tickets` |
