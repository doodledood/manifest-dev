...
- **Data is isolated from shell.** A refresh replaces the small session payload rather than rewriting the interaction shell; without that split, live updating is not affordable.
