# ADR: figure-out settles an artifact's own person before drafting, and opens an open visual direction with variants
...
- **Plain reruns as variants:** in the blind comparisons, pages generated without a named difference converged on the same concept, which gives the user near-copies to choose between.
