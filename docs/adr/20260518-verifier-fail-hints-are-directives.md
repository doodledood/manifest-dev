...
- `/do` is unchanged for this work — no cross-file invariant duplication, no special dispatch logic, no per-iteration carve-out paragraphs added to `/do`'s SKILL.md.
