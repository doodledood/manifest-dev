...
|--------|----------------|
| [`manifest-dev`](./manifest-dev) | Understanding a problem, writing down what you'd accept, executing against it and verifying durable results that support subsequent correct work. Also project setup, ticket authoring and execution, first-principles design guidance (`/design`), artifact review (`/review-design`), and the review skills the criteria call on. |
