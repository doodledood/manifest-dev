...
*If the next message describes a change or new requirement (not a pure question), invoke `/manifest-dev-experimental:define <this-manifest-path>` to amend. Pure questions are answered inline.*
