...
State the primary user outcome, the intended visual or emotional experience, and any secondary outcome that must survive. Where the creator seeks an action, name what makes that action an informed success for the person taking it. These are examples, not exclusive categories:
