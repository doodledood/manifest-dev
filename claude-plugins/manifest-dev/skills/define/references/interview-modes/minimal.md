...
Use AskUserQuestion only when the decision materially affects scope or has no clear recommended choice. For all other items, pick the recommended option and log it as auto-decided.
