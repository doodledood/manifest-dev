---
name: design-v2
description: 'Guide visual and interaction design with curated references, clean hierarchy and purposeful aliveness. HTML-first across landing pages, visual explainers and slideshows. Use when the user asks for design-v2 or reference-calibrated design.'
...
| Long-form visual research or explainers | `references/long-form-explainers.md` |
| Quick visual ELI5 explainers, including internal PM briefs | `references/quick-visual-explainers.md` |
