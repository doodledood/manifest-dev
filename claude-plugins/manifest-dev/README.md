...
| Research | `skills/define/tasks/RESEARCH.md` | Research, investigation, analysis |
| Blog | `skills/define/tasks/BLOG.md` | Blog posts, content writing |
| Other | (none) | Doesn't fit above |
...
| Agent | Purpose |
|-------|---------|
| `claude-md-adherence-reviewer` | Checks adherence to project instructions |
| `code-bugs-reviewer` | Focused bug detection |
| `code-coverage-reviewer` | Test coverage gaps |
| `code-maintainability-reviewer` | Code quality and maintainability |
| `code-simplicity-reviewer` | Over-engineering and cognitive complexity |
| `code-testability-reviewer` | Identify code requiring excessive mocking |
