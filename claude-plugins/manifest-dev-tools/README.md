...
| `/prompt-engineering` | Create, update, or review an LLM prompt — system prompt, skill, or agent. State the goal, let the model supply the rest, and keep only the lines it could not reach on its own. |
