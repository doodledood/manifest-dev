...
| `/re-explain` | Stop and re-pitch the last message — it didn't land. Re-explains with the context the reader was missing, in plain words and the project's own vocabulary, cutting every line that isn't value while keeping every fact that is. |
