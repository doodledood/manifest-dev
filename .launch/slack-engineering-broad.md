...
I call it manifest-driven development:
...
That said, I packaged it as a Claude Code plugin if you want to try the structured version: https://github.com/doodledood/manifest-dev

Wrote up the full approach with a worked example: [BLOG_URL]
